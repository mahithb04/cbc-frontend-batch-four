                ...
                <div className="w-full h-full flex">
                    ...
                    <div className="w-[50%] h-full p-[40px]">
                        ...
                        <div className="w-full flex justify-center mb-[40px]">
                            ...
                            <button className="bg-pink-800 border border-pink-800 cursor-pointer text-white w-[200px] h-[50px] rounded-lg hover:bg-white hover:text-pink-800 transition-all duration-300 ease-in-out">
                                Buy Now
                            </button>
                        </div>
