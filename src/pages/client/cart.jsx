        ...
        <div className="w-full h-full flex justify-center p-[40px]">
            <div className="w-[700px]">
                        ...
                        return(
                            <div key={index} className="w-full h-[100px] bg-white shadow-2xl my-[5px] flex justify-between items-center relative">
                                ...
                                <div className="h-full max-w-[300px] w-[300px] overflow-hidden">
                                    ...
                                    <h2 className="text-small text-gray-500">{item.altNames.join(" | ")}</h2>
                                    <h2 className="text-small text-gray-500">LKR: {item.price.toFixed(2)}</h2>
                                </div>
                                ...
                                <div className="h-full w-[100px] flex justify-center items-center">
                                    <h1 className="text-xl ">LKR: {(item.price * item.quantity).toFixed(2)}</h1>
                                </div>
                            </div>
                        )
                    })
                ...
                <div className="w-full flex justify-end mt-4">
                    <button className="w-[170px] text-xl text-center pr-2 bg-pink-400 text-white h-[40px] rounded-lg cursor-pointer" onClick={()=>{
                        navigate("/checkout" ,
                            {
                                state : {
                                    items : cart
